DROP TABLE IF EXISTS USER_DB_COBRA.PUBLIC.NETFLIX_STAGING_ZONE;
DROP TABLE IF EXISTS USER_DB_COBRA.PUBLIC.NETFLIX_TITLES;
DROP TABLE IF EXISTS USER_DB_COBRA.PUBLIC.TMDB_GENRES;
DROP TABLE IF EXISTS USER_DB_COBRA.PUBLIC.TMDB_TRENDING;
